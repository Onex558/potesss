...
(function (Promise) {
   ...
   function IALoader(canvas, game, callbacks, scale) {
     ...
     if (/archive\.org$/.test(document.location.hostname)) {
       images = { ia: img("https://vfat.classicreload.com/v6-legacy/img/PDGO-LOAD.gif"),
                      mame: img("https://vfat.classicreload.com/v6-legacy/img/mame.png"),
                      mess: img("https://vfat.classicreload.com/v6-legacy/img/mame.png"),
                      dosbox: img("https://vfat.classicreload.com/v6-legacy/img/dosbox.png"),
                      sae: img("https://vfat.classicreload.com/v6-legacy/img/sae.png"),
                  pce: img("https://vfat.classicreload.com/v6-legacy/img/pce.png")
                };
     } else {
       images = { ia: img("https://vfat.classicreload.com/v6-legacy/img/PDGO-LOAD.gif"),
                  mame: img("https://vfat.classicreload.com/v6-legacy/img/mame.png"),
     ...
     var get_emulator_config_url = function (module) {
       return 'https://vfat.classicreload.com/v6-legacy/' + module + '.json';
     };

     var get_other_emulator_config_url = function (module) {
       return 'https://vfat.classicreload.com/emularity_config_v1/' + module + '.cfg';
     };

     var get_meta_url = function (game_path) {
       var path = game_path.split('/');
       return "https://vfat.classicreload.com/"+ path[0] +"/"+ path[0] +"_meta.xml";
     };

     var get_files_url = function (game_path) {
       var path = game_path.split('/');
       return "https://vfat.classicreload.com/"+ path[0] +"/"+ path[0] +"_files.xml";
     };

     var get_zip_url = function (game_path, item_path) {
       if (item_path) {
         return "https://vfat.classicreload.com/"+ item_path +"/"+ game_path;
       }
       return "https://vfat.classicreload.com/"+ game_path;
     };

     var get_js_url = function (js_filename) {
       return "https://vfat.classicreload.com/v6-legacy/"+ js_filename;
     };

     var get_bios_url = function (bios_filename) {
       return "https://vfat.classicreload.com/emularity_bios_v1/"+ bios_filename;
     };
